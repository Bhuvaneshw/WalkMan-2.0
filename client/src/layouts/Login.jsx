...
export default function Login() {
    ...
    return (
        <Flex
            ...
            background={'#f5f5f5'}>
            <Stack style={{
                display: 'flex', flex: '3', height: '100vh',
                ...
                <Stack style={{
                    ...
                    <div style={{
                        ...
                        <h1 style={{fontSize: '40px', fontWeight: 'bold'}}
                            className='absCenter noWrap'>Sign in
                            to<br/> WalkMan 2.0</h1>
                    </div>
                </Stack>
                <HStack justifyContent='space-between' pad='20px' flex='3'>
                    ...
                    <Stack>
                        ...
                        <HStack><Text>You can&nbsp;</Text><a href='/signup' style={{
                            color: '#5F04A7',
                            fontWeight: 'bold'
                        }}>Create an account</a></HStack>
                    </Stack>
                    <Stack>
                        <Icon src='/user.svg' size='100px'/>
                    </Stack>
