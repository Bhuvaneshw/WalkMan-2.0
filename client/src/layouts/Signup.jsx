...
export default function Signup() {
    return (
        <MouseParallaxContainer containerStyle={{background: "#19282b"}}>
            <MouseParallaxChild factorX={0.05} factorY={0.05} style={{}}>
                <CircleDiv
                    top="-15vw"
                    left="-10vw"
                    bg="#5425B8"
            ...
            <MouseParallaxChild factorX={0.21} factorY={0.22} style={{}}>
                <CircleDiv
                    bottom="-85vw"
                    right="-15vw"
                    bg="#27A2A2"
